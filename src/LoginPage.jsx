...
export default function LoginPage() {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      console.log("Firebase 에러 메시지:", error.message);
  ...
  return (
    <form className="flex flex-col" onSubmit={handleLogin}>
      {/* 이메일 입력 필드 */}
      <input type="email" placeholder="이메일" className="input" onChange={(e) => setEmail(e.target.value)} />
      {/* 비밀번호 입력 필드 */}
      <input type="password" placeholder="비밀번호" className="input" onChange={(e) => setPassword(e.target.value)} />
      {/* 로그인 버튼 */}
